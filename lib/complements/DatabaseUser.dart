...
class DatabaseUser {
  ...
  static final columnPass = 'pass'; // torna esta classe singleton

  static final DatabaseUser instance =
      DatabaseUser(); // tem somente uma referência ao banco de dados
  ...
  // no Map é um login de coluna e o valor é o valor da coluna.
